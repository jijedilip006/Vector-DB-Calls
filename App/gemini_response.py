...
api_key=os.getenv("GEMINI_API_KEY_JV")
...
def generate_answer(query, search_results):
    ...
    If the user specifies what client side they are from, then read the name of the record returned and answer according to what matches the user input
